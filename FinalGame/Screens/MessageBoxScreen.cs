...
namespace FinalGame.Screens
{
    ...
    public class MessageBoxScreen : GameScreen
    {
        ...
        private Texture2D _backgroudRectangleTexture;
        ...
        public override void Activate()
        {
            ...
            _backgroudRectangleTexture = content.Load<Texture2D>("invertedGrid");
        }
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            var textSize = font.MeasureString(_message) * Scale;
            ...
            spriteBatch.Draw(_backgroudRectangleTexture, backgroundRectangle, Color.Blue);
            //spriteBatch.DrawString(font, _message, textPosition, color);
            spriteBatch.DrawString(font, _message, textPosition, color, 0,
